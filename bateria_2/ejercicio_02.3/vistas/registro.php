    ...
    <body>
        ...
        <form action="index.php" method="POST">
            ...
            <input id="nombre" type="text" required="required" name="nombre" size="30" 
                   placeholder="<?= isset($editar) ? $nombreUsuario : "Nombre de usuario" ?>"/><br>
            <label for="contrasenia">Contraseña:</label>
            <input id="contrasenia" type="password" required="required" size="20" 
                   name="contrasenia" placeholder="<?= isset($editar) ? $clave : "4 números" ?>"/><br>
            ...
            if (isset($editar)) {
                ?>
                <label for="boton_nuevos_datos">Pulse para modificar sus datos</label>
